<template>
  <div :class="['bottom-sheet dark:bg-dark-surface', { opened: opened, closed: opened === false, moving: moving }]" v-on="handlers" ref="bottomSheet">
    ...
    <div :style="[{ bottom: cardP+'px', maxWidth: maxWidth, maxHeight: maxHeight },{'height':isFullScreen ? '100%' : 'auto'}]" :class="['bottom-sheet__card bg-white dark:bg-dark-surface', { stripe: stripe, square: !rounded }, effect]" ref="bottomSheetCard">
