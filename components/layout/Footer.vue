<template>
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 dark:text-gray-100">
      <span class="ml-3 text-xl">Gourmet</span>
    </a>
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 —
      <a href="#" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@mo3ly</a>
    </p>
    <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      <a target="_blank" href="https://instagram.com/gourmetdistrict.qa/" class="ml-3 text-gray-500">
  ...
  <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    ...
    <div class="flex justify-between pt-5 pb-10 border-t flex-row">
      ...
      <div class="flex items-center space-x-4 smt-0">
        ...
        <a target="_blank" href="https://instagram.com/gourmetdistrict.qa/" class="text-gray-500 transition-colors duration-300 hover:text-pink-400">
