        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-10">
                ...
                <ul class="mt-3">
                  ...
                  <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                      <nuxt-link :to="localePath('/admin/bookings')" aria-current="page" class="block text-gray-200 hover:text-white transition duration-150 false active" href="/" style="outline: none;">
                        <div class="flex flex-grow">
                            <svg class="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                  ...
                  <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                      <nuxt-link :to="localePath('/admin/qrcode')"  aria-current="page" class="block text-gray-200 hover:text-white transition duration-150 false active" href="/" style="outline: none;">
                        <div class="flex flex-grow">
                            <svg class="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                  ...
                  <!-- <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                      <a aria-current="page" class="block text-gray-200 hover:text-white transition duration-150 false active" href="/" style="outline: none;">
                        <div class="flex items-center justify-between">
                            <div class="flex flex-grow">
                              <svg class="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-shrink-0 ml-2">
                              <svg class="w-3 h-3 flex-shrink-0 ml-1 fill-current text-gray-400 false" viewBox="0 0 12 12">
                      ...
                      <ul class="pl-9 mt-1 hidden">
                        <li class="mb-1 last:mb-0"><a aria-current="page" class="block text-gray-200 hover:text-white transition duration-150 false active" href="/" style="outline: none;"><span class="text-sm font-medium">Team - Tabs</span></a></li>
                        <li class="mb-1 last:mb-0"><a aria-current="page" class="block text-gray-200 hover:text-white transition duration-150&quot; false active" href="/" style="outline: none;"><span class="text-sm font-medium">Team - Tiles</span></a></li>
                      </ul>
                  </li>
                  <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                      <a aria-current="page" class="block text-gray-200 hover:text-white transition duration-150 false active" href="/" style="outline: none;">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <div v-if="dropdownOpen"
                            ...
                            <a href="#"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-600 hover:text-white">Return to home</a>
                            <a href="/login"
...
<script>
export default {
  // add the channel listener here so events can be called every where in the admin panel
  data() {
    return {
      sidebarOpen: false,
      dropdownOpen: false,
