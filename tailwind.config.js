...
module.exports = {
  theme: {
    extend: {
      ...
      fill: theme => ({
        'gd-gray': theme('colors.gd.gray'),
        'gd-lightindigo': theme('colors.gd.lightindigo'),
        'gd-indigo': theme('colors.gd.indigo')
      }),
      stroke: theme => ({
        'gd-gray': theme('colors.gd.gray'),
        'gd-lightindigo': theme('colors.gd.lightindigo'),
      ...
      boxShadow: {
        gdmobarmg: '0px 0px 8px rgba(0, 0, 0, 0.101562)',
        reverse: '0 -2px 4px 0 rgba(0, 0, 0, 0.05)',
        'inset-gd': 'inset 0px 0px 8px rgba(0, 0, 0, 0.101562)'
      },
