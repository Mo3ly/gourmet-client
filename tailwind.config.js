...
module.exports = {
  ...
  variants: {
    ...
    borderColor: ["responsive", "hover", "focus", "active", "dark", "light", "after", "light:after", "dark:after"],
    backgroundColor: ["responsive", "hover", "focus", "active", "dark", "light", "dark:hover", "light:hover"],
    textColor: ["responsive", "hover", "focus", "active", "group-hover", "dark", "light", "dark:hover", "light:hover"],
