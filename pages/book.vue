<template>
  <div>
    ...
    <div class="container px-5 lg:w-1/2 py-5 mx-auto text-center">
      <div class="mt-3 w-full sm:text-left">
        <h3 class="text-lg leading-6 font-medium text-gray-500 mb-4">
      ...
      <div class="bg-gray-50 px-4 py-4 text-center w">
        <button @click="book()" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-pink-600 text-base font-medium text-white hover:bg-pink-700 outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 sm:ml-3 sm:w-auto sm:text-sm">
          Confirm
        </button>
